...
function parseRequiredString(name: string, fallback = ''): string {
...
export const env = {
  ...
  DATA_QUALITY_REPORTING_ANOMALY_ALERT_THRESHOLD: parseNumber(
    process.env.DATA_QUALITY_REPORTING_ANOMALY_ALERT_THRESHOLD,
    0.4
  ),
  ...
  DATA_QUALITY_DUPLICATE_CANONICAL_ALERT_THRESHOLD: parseNumber(
    process.env.DATA_QUALITY_DUPLICATE_CANONICAL_ALERT_THRESHOLD,
    5
  ),
  DATA_QUALITY_CONFLICTING_SHOPIFY_ALERT_THRESHOLD: parseNumber(
    process.env.DATA_QUALITY_CONFLICTING_SHOPIFY_ALERT_THRESHOLD,
    5
  ),
