...
function pushQueryParamValue(target: Record<string, string | string[]>, key: string, value: string): void {
...
export async function recordAdSyncApiTransaction(input: AdSyncApiTransactionInput): Promise<void> {
  await query(
    `
