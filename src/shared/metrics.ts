...
export function safeDivide(numerator: NumericLike, denominator: NumericLike): number | null {
...
export function compareMetricValues(left: string | number | null, right: string | number | null): number {
