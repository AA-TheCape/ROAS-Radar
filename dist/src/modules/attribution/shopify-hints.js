...
export function extractShopifyHintAttribution(payload) {
    ...
    const rawDimensions = {
        source: getAttributeValueFromKeys(noteAttributes, [
            "utm_source",
        ...
        medium: getAttributeValueFromKeys(noteAttributes, [
            "utm_medium",
        ...
        campaign: getAttributeValueFromKeys(noteAttributes, [
            "utm_campaign",
        ...
        content: getAttributeValueFromKeys(noteAttributes, [
            "utm_content",
        ...
        term: getAttributeValueFromKeys(noteAttributes, [
            "utm_term",
            "roas_radar_utm_term",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        gclid: getAttributeValueFromKeys(noteAttributes, [
            "gclid",
            "roas_radar_gclid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        gbraid: getAttributeValueFromKeys(noteAttributes, [
            "gbraid",
            "roas_radar_gbraid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        wbraid: getAttributeValueFromKeys(noteAttributes, [
            "wbraid",
            "roas_radar_wbraid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        fbclid: getAttributeValueFromKeys(noteAttributes, [
            "fbclid",
            "roas_radar_fbclid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        ttclid: getAttributeValueFromKeys(noteAttributes, [
            "ttclid",
            "roas_radar_ttclid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
        ...
        msclkid: getAttributeValueFromKeys(noteAttributes, [
            "msclkid",
            "roas_radar_msclkid",
        ]) ??
            getAttributeValueFromKeys(legacyAttributes, [
    ...
    for (const candidate of hintCandidates) {
        try {
            const url = new URL(normalizeAttributionUrl(candidate, "https://shopify-hint.local") ??
                candidate);
