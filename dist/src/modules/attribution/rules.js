...
export const DEFAULT_ATTRIBUTION_LOOKBACK_WINDOWS = {
    clickWindowDays: DEFAULT_CLICK_LOOKBACK_WINDOW_DAYS,
    viewWindowDays: DEFAULT_VIEW_LOOKBACK_WINDOW_DAYS
};
export function normalizeAttributionLookbackWindows(windows) {
...
export function lookbackWindowMs(days) {
...
export function isWithinLookbackWindow(orderOccurredAt, touchpointOccurredAt, engagementType, windows) {
