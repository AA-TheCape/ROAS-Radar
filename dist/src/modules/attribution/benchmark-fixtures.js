...
function buildTouchpoint(touchpointId, occurredAt, overrides = {}) {
    return {
        touchpointId,
...
function weightedCredit(touchpointId, revenueCredit, creditWeight, isPrimary, overrides = {}) {
    return {
        touchpointId,
        revenueCredit,
        creditWeight,
...
function winnerTakeAll(winnerTouchpointId, totalRevenueCredited, touchpointCountConsidered, eligibleClickCount, eligibleViewCount, lookbackRuleApplied, options = {}) {
    return {
...
function linearSplit(credits, touchpointCountConsidered, eligibleClickCount, eligibleViewCount, lookbackRuleApplied) {
    return {
...
function noCredit(allocationStatus, touchpointCountConsidered, eligibleClickCount, eligibleViewCount, lookbackRuleApplied, options = {}) {
    return {
        allocationStatus,
...
export const NORTHBEAM_BENCHMARK_FIXTURES = [
    {
