...
const envSchema = zod_1.z.object({
    ...
    REPORTING_API_TOKEN: zod_1.z.string().default('dev-reporting-token'),
    ...
    SHOPIFY_WEBHOOK_SECRET: zod_1.z.string().optional().default(''),
    SHOPIFY_APP_API_KEY: zod_1.z.string().optional().default(''),
    SHOPIFY_APP_API_SECRET: zod_1.z.string().optional().default(''),
    SHOPIFY_APP_API_VERSION: zod_1.z.string().optional().default('2026-01'),
    SHOPIFY_APP_BASE_URL: zod_1.z.string().optional().default('http://localhost:8080'),
    SHOPIFY_APP_ENCRYPTION_KEY: zod_1.z.string().optional().default(''),
    SHOPIFY_APP_POST_INSTALL_REDIRECT_URL: zod_1.z.string().optional().default(''),
    ...
    META_ADS_APP_ID: zod_1.z.string().optional().default(''),
    META_ADS_APP_SECRET: zod_1.z.string().optional().default(''),
    META_ADS_APP_BASE_URL: zod_1.z.string().optional().default('http://localhost:8080'),
    META_ADS_APP_SCOPES: stringList.default([]),
    META_ADS_AD_ACCOUNT_ID: zod_1.z.string().optional().default(''),
    META_ADS_API_VERSION: zod_1.z.string().optional().default('v23.0'),
    META_ADS_ENCRYPTION_KEY: zod_1.z.string().optional().default(''),
    ...
    GOOGLE_ADS_APP_BASE_URL: zod_1.z.string().optional().default('http://localhost:8080'),
    GOOGLE_ADS_CLIENT_ID: zod_1.z.string().optional().default(''),
    GOOGLE_ADS_CLIENT_SECRET: zod_1.z.string().optional().default(''),
    ...
    GOOGLE_ADS_API_VERSION: zod_1.z.string().optional().default('v19'),
    GOOGLE_ADS_ENCRYPTION_KEY: zod_1.z.string().optional().default(''),
    ...
    DATA_QUALITY_ANOMALY_THRESHOLD_RATIO: zod_1.z.coerce.number().default(0.35),
    DATA_QUALITY_ANOMALY_MIN_BASELINE: zod_1.z.coerce.number().default(5),
