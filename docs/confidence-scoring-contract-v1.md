...
Scores are bounded decimals in the inclusive range `0 <= score <= 1`. Writers must clamp explicit candidate scores into that range and round persisted values to no more than four decimal places.
