		...
		note_attributes: [
			{
				name: "page_url",
				value:
					"https://store.example/products/widget?utm_source=Google&utm_medium=CPC&gbraid=GBRAID-123#section",
			},
			{
				name: "referrer_url",
				value:
					"https://www.google.com/search?q=widget&utm_source=should-not-win",
			},
		],
		line_items: [],
	});
