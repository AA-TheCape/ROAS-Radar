	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				"panel-tint":
					"linear-gradient(180deg, rgba(255, 255, 255, 0.82), rgba(244, 233, 226, 0.8))",
			},
			spacing: {
				gutter: "1rem",
				section: "1.5rem",
			...
			fontSize: {
				...
				metric: [
					...
					{ lineHeight: "0.96", letterSpacing: "-0.05em", fontWeight: "700" },
				],
				lead: [
					"1.0625rem",
				...
				label: [
					"0.8125rem",
					{ lineHeight: "1.35rem", letterSpacing: "0.08em", fontWeight: "600" },
				],
				caption: [
					"0.75rem",
					{ lineHeight: "1.25rem", letterSpacing: "0.14em", fontWeight: "600" },
				],
			},
			keyframes: {
				"fade-up": {
