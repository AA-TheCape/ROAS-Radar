...
META_ADS_SECRET_FLAGS="META_ADS_APP_SECRET=META_ADS_APP_SECRET:latest,META_ADS_ENCRYPTION_KEY=META_ADS_ENCRYPTION_KEY:latest,META_ADS_METADATA_ACCESS_TOKEN=$META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:latest"
