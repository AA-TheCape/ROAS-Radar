...
grant_secret_access "$API_SERVICE_ACCOUNT_NAME" "${META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:-META_ADS_METADATA_ACCESS_TOKEN}"
...
grant_secret_access "$WORKER_SERVICE_ACCOUNT_NAME" "${META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:-META_ADS_METADATA_ACCESS_TOKEN}"
...
grant_secret_access "$META_ADS_JOB_SERVICE_ACCOUNT_NAME" "${META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:-META_ADS_METADATA_ACCESS_TOKEN}"
...
grant_secret_access "$META_ADS_DETERMINISTIC_JOB_SERVICE_ACCOUNT_NAME" "${META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:-META_ADS_METADATA_ACCESS_TOKEN}"
...
grant_secret_access "$CAMPAIGN_METADATA_BACKFILL_JOB_SERVICE_ACCOUNT_NAME" "${META_ADS_METADATA_ACCESS_TOKEN_SECRET_NAME:-META_ADS_METADATA_ACCESS_TOKEN}"
